...
const LandingPageDashBoard = () => {
	...
	return (
		...
		// 				aria-hidden="true"
		// 			>
		// 				<polygon points="50,0 100,0 50,100 0,100" className="" />
		// 			</svg>
		...
		<div className="container w-screen">
			<nav className="w-screen z-10 fixed top-0   flex flex-row py-3 items-center bg-blue-200 bg-gradient-to-r from-white shadow-md te">
				<div className="mx-6 my-3 items-center">
					<img alt=" Company Logo" className="h-8 w-auto sm:h-10" src="/vite.svg" />
				</div>

				<ul className="mx-8 py-3 flex flex-row">
			...
			<div className="w-screen  h-screen mx-auto mt-12   flex flex-col md:flex-row">
				<div className=" left w-full md:w-3/5 h-screen md:h-auto mx-0 py-0   items-center flex flex-row">
					<div className="mx-auto mt-12 md:mt-auto px-6 py-12 w-full   my-auto">
						...
						<a className="  mx-6 my-12 py-3 px-8 bg-violet-600 rounded-lg  text-lg text-white  font-medium">Get Started</a>
					</div>

					<svg
						className="hidden md:flex inset-y-0 right-0   h-full w-48 translate-x-1/2 transform text-white lg:block"
						fill="currentColor"
						viewBox="0 0 100 100"
						preserveAspectRatio="none"
						aria-hidden="true"
				...
				<div className=" right md:w-2/5  mx-auto h-auto md-mx-0">
					<img
